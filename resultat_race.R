...
MA_peak_plot_team_race <- function() {
  ...
  ggsave("img/constructor_advantage_MA.png", plot = plottning, width = 9, height = 9, bg = "white")
}
...
MA_peak_plot_driver_race <- function() {
  ...
  ggsave("img/driver_skill_MA.png", plot = plottning, width = 9, height = 9, bg = "white")
}
