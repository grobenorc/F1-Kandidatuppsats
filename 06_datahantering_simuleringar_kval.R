...
vilken_modell
fit <- read_rds("fit/fit_circuit_kval.rds") # Vi går vidare med den bästa modellen
...
write_rds(driver_skill_summary, "fit/summary_koef_driver_kval.rds")
write_rds(driver_samples, "fit/samples_koef_driver_kval.rds")
...
constructor_advantage_summary <-
  ...
  summarise(
    ...
    n = n())
write_rds(constructor_advantage_summary, "fit/summary_koef_team_kval.rds")
write_rds(constructor_samples, "fit/samples_koef_team_kval.rds")
